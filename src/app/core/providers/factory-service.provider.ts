...
import { LaneElementFactory } from "../interfaces/lane-element.factory";
...
export class FactoryServiceProvider {
	...
	createForLaneTool ( type: ToolType ): LaneElementFactory<any> {

		let factory: LaneElementFactory<any>;
