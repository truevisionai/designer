...
export class ExplicitSpline extends AbstractSpline {
	...
	//
	// 	for ( const segment of this.segmentMap.values() ) {
	//
	// 		geometries.push( ...this.exportGeometries() );
	//
	// 	}
	//
	// }
	...
	//
	// 	if ( this.geometryTypes[ index ] == TvGeometryType.LINE ) {
	//
	...
	//
	// 	} else if ( this.geometryTypes[ index ] == TvGeometryType.ARC ) {
	//
	...
	// 		bufferAttribute.needsUpdate = true;
	//
	// 	} else if ( this.geometryTypes[ index ] == TvGeometryType.SPIRAL ) {
	//
	// 		const sd = SPIRAL.vec2Angle( dir1.x, dir1.y );
	// 		const ed = SPIRAL.vec2Angle( dir2.x, dir2.y );
	//
	...
	// 		bufferAttribute.needsUpdate = true;
	//
	// 	} else if ( this.geometryTypes[ index ] == TvGeometryType.PARAMPOLY3 ) {
	//
