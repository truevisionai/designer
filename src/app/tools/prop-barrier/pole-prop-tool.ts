...
import { PoleRoadObjectInspector } from "./pole-road-object-inspector";
...
export class PolePropTool extends BaseTool {
	...
	onObjectSelected ( object: any ): void {
		...
		if ( object instanceof TvRoadObject ) {
			...
			AppInspector.setDynamicInspector( new PoleRoadObjectInspector( object ) );
	...
	onObjectUpdated ( object: any ): void {
		...
		} else if ( object instanceof PoleRoadObjectInspector ) {
