...
export class JunctionDebugFactory {
	...
	createJunctionGateLine ( junction: TvJunction, coord: TvLaneCoord, color: any = ColorUtils.CYAN, width: number = 8 ): JunctionGateLine {
	...
	createLineMaterial ( color: any = ColorUtils.CYAN, lineWidth: number = 2 ): LineMaterial {
