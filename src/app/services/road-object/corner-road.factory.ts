...
export class CornerRoadFactory {
	...
	static createCornerRoadOutline ( road: TvRoad, outline: TvObjectOutline, s: number, t: number, height: number = 0.0, dz = 0.0 ): any {
	...
	static createCornerLocalOutline ( outline: TvObjectOutline, u: number, v: number, z: number = 0.0, height = 0.0 ): any {
