...
// */
//
//import { OdTextures } from 'app/modules/tv-models/builders/od.textures';
//import { TravelDirection, TvContactPoint, TvLaneSide, TvLaneType } from 'app/modules/tv-models/models/tv-common';
//import { TvJunctionLaneLink } from 'app/modules/tv-models/models/junctions/tv-junction-lane-link';
...
//			return this.models.getJunctionById( this.road.predecessor.elementId );
//		}
//
//		if ( this.contact === TvContactPoint.END && this.road.successor?.elementType === 'junction' ) {
//			return this.models.getJunctionById( this.road.successor.elementId );
//		}
//	}
//
...
//		const results = [];
//
//		const junctions = this.models.getJunctions();
//
...
//			return this.models.getJunctionById( exit.road.predecessor.elementId );
//		}
//
//		if ( exit.contact === TvContactPoint.START && exit.road.successor?.elementType === 'junction' ) {
//			return this.models.getJunctionById( exit.road.successor.elementId );
//		}
//
//	}
//
