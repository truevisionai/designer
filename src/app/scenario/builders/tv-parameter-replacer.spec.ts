...
describe( 'ParameterReplacer tests', () => {
	...
	//     reader = new ReaderService( fileService );
	...
	//     const egoAction = EGO.initActions[ 0 ] as SpeedAction;
	//     const a1Action = A1.initActions[ 0 ] as SpeedAction;
