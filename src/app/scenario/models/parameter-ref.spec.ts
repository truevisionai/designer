...
//		scenario.parameterDeclarations.splice( 0, scenario.parameterDeclarations.length );
//		scenario.addParameterDeclaration( new ParameterDeclaration( new Parameter( '$A', ParameterType.integer, '5' ) ) );
//		scenario.addParameterDeclaration( new ParameterDeclaration( new Parameter( '$B', ParameterType.double, '2.5' ) ) );
//		scenario.addParameterDeclaration( new ParameterDeclaration( new Parameter( '$C', ParameterType.integer, '8' ) ) );
//	} );
//
...
//		scenario = new TvScenario();
//		scenario.parameterDeclarations.splice( 0, scenario.parameterDeclarations.length );
//		scenario.addParameterDeclaration( new ParameterDeclaration( new Parameter( '$A', ParameterType.boolean, 'true' ) ) );
//		scenario.addParameterDeclaration( new ParameterDeclaration( new Parameter( '$B', ParameterType.boolean, 'false' ) ) );
//		scenario.addParameterDeclaration( new ParameterDeclaration( new Parameter( '$C', ParameterType.boolean, 'false' ) ) );
//	} );
//
